...
<head>
    ...
    <!-- Link our CSS file -->
    <link rel="stylesheet" href="../foodorder/css/style.css">
</head>
<?php 
        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder=" EnterFull Name" class="input-responsive" required>
